#!/usr/bin/env python3
"""
Experiment: sweep number of in-context examples (n).
...
def train_models_fixed_steps(models, steps, d, n_points, batch_size, lr, sigma, device, use_amp=False):
...
def main():
    ...
    parser.add_argument('--n_points_list', type=int, nargs='+',
                        default=[5, 10, 20, 40],
                        help='List of in-context example counts')
    parser.add_argument('--num_layers', type=int, default=8)
    parser.add_argument('--hidden_dim', type=int, default=None)
    parser.add_argument('--train_steps', type=int, default=10000,
                        help='Number of optimizer steps to train each model')
    parser.add_argument('--batch_size', type=int, default=64)
    parser.add_argument('--lr', type=float, default=1e-3)
    parser.add_argument('--sigma', type=float, default=0.0)
    parser.add_argument('--eta', type=float, default=0.1)
    parser.add_argument('--num_eval_tasks', type=int, default=1000)
    parser.add_argument('--output_dir', type=str, default='./results/exp_context_sweep')
