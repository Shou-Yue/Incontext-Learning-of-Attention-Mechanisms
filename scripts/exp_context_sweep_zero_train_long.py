#!/usr/bin/env python3
"""
Experiment: in-context sweep with ZERO training (random init), extended n_points.
...
def main():
    parser = argparse.ArgumentParser(description="Zero-train in-context sweep (extended n_points)")
    parser.add_argument('--d', type=int, default=20)
    parser.add_argument('--n_points_list', type=int, nargs='+',
                        default=[5, 10, 20, 40, 80, 120, 160, 200])
    ...
    parser.add_argument('--output_dir', type=str,
                        default='./results/exp_context_sweep_zero_long')
